...
1.  Coded in TypeScript languages on Visual Studio Code.
2.  React Native framework using Expo Router navigation.
3.  Authentication, user database, other backend servies through Supabase.
4.  Primarily tested through physical IOS device using the Expo Go mobile app.

## Installation and Hosting (for Expo Go)

1. Open bash / terminal
2. git clone https://github.com/adambiscoe/WolFlex2.0.git
3. cd your-repo
4. npm install
5. Copy `.env.example` to `.env` and fill in your Supabase project URL and publishable key (Supabase dashboard → Project Settings → API Keys)
6. npm run start

## Resources and Credits

1.  AI assistance via ChatGPT(https://chat.openai.com/) and Claude Code (https://claude.com/product/claude-code)
2.  Primary Tutorials:
